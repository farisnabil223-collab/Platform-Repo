...
export default function AdminAuditPage() {
  ...
  const logs = [
    ...
    { id: '3', actor: 'System Auto-Task', action: 'TUITION_INVOICE_GENERATED', entity: 'Invoice', date: '08:00 AM', traceId: 'tr-554-k88', before: 'Status: PENDING', after: 'Status: GENERATED' },
  ];
