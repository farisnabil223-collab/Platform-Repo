...
export default function AdminAnalyticsPage() {
  ...
  const students = [
    { id: '1', name: 'Omar Watson', grade: 'Grade 11 - Advanced', missingAssignments: 0, standing: 'SAFE' },
    { id: '2', name: 'Sophie Watson', grade: 'Grade 9 - Standard', missingAssignments: 3, standing: 'HIGH' },
  ];
  ...
  const selectedRisk = React.useMemo(() => {
    ...
    const student = students.find((c) => c.id === selectedStudentId);
  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-3 gap-6 items-start">
        {/* Analytics Chart & Report Scheduler */}
          ...
          <Card className="bg-card border border-border/60">
            <CardHeader className="flex flex-row justify-between items-center pb-2">
              ...
              <div className="flex gap-1.5">
                {(['ACADEMIC', 'FINANCIAL', 'ATTENDANCE'] as const).map((m) => (
                  <button
                    key={m}
                    onClick={() => setMetric(m)}
