...
export default function ParentAIAssistantPage() {
  const [messages, setMessages] = React.useState<any[]>([
    { id: '1', sender: 'ai', text: 'Hello! I am your AI parent advisor. I can summarize your child\'s attendance logs, review academic performance, or explain study schedules.' },
  ]);
  const [inputText, setInputText] = React.useState('');
  const [conversationId, setConversationId] = React.useState<string | null>(null);

  React.useEffect(() => {
    api.post('/v1/ai/copilot/conversations', { title: 'Parent Chat Session' })
      .then((res: any) => {
  ...
  const shortcuts = [
    { label: 'Progress Summary', prompt: 'Summarize Sophia\'s academic progress and performance.' },
    { label: 'Risk Alert Info', prompt: 'Explain the attendance warning indicators.' },
  ];

  return (
    <PortalLayout
      role="PARENT"
      pageTitle="AI Parent Advisor"
      pageDescription="Summarize dependent grades progress, understand student standing alerts, and review upcoming deadlines."
    >
