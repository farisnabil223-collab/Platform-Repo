...
export const mockCourses: Course[] = [
  {
    ...
    instructorEmail: 'emily.watson@eduverse.com',
    progress: 75,
    category: 'Mathematics',
    status: 'ACTIVE',
    syllabus: 'This course covers the fundamentals of calculus including limits, derivatives, integrals, and their application to physical sciences.',
  ...
  },
  {
    ...
    code: 'PHYS-202',
    instructor: 'Dr. Arthur Feynman',
    instructorEmail: 'arthur.feynman@eduverse.com',
    progress: 40,
    category: 'Science',
    status: 'ACTIVE',
    syllabus: 'An introduction to quantum mechanics, particle-wave duality, the Schrödinger equation, and quantum entanglement models.',
  ...
  },
  {
    ...
    instructorEmail: 'linus.torvalds@eduverse.com',
    progress: 90,
    category: 'Tech',
    status: 'ACTIVE',
    syllabus: 'Understanding processor logic, memory hierarchies, cache systems, scheduling algorithms, and kernel process management.',
